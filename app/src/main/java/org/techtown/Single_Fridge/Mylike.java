...
import org.techtown.Single_Fridge.Requests.MypageRequest_mylike;
...
public class Mylike extends AppCompatActivity {
    String UserId;
    ListView listView;
    ArrayList<Mylike.Info_b> InfoList = new ArrayList<Mylike.Info_b>();
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(Mylike.this, R.layout.list_textview, RecipeList);
        listView.setAdapter(adapter);

        Response.Listener<String> responseListener_mylike = new Response.Listener<String>() {
            @Override
        ...
        MypageRequest_mylike MypageRequest_mylike_ = new MypageRequest_mylike(UserId, responseListener_mylike);
        RequestQueue queue = Volley.newRequestQueue(Mylike.this);
        queue.add(MypageRequest_mylike_);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {

                Intent intent = new Intent(Mylike.this, Detail.class);
