...
import org.techtown.Single_Fridge.Myinfo_social;
            ...
            if(UserPW == null) {    //소셜 로그인 된 상태
                ...
                Logout.setOnClickListener(new View.OnClickListener(){
                    ...
                    public void onClick(View view){
                        ...
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Logout.class);
                        getActivity().startActivityForResult(intent, 400);
                    }
                });
                updateKakaoLoginUi();
                Myrecipe.setOnClickListener(new View.OnClickListener(){
                    @Override
                    public void onClick(View view){
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Myrecipe.class);
                ...
                Mylike.setOnClickListener(new View.OnClickListener(){
                    @Override
                    public void onClick(View view){
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Mylike.class);
                        startActivity(intent);
                    }
                });
                ...
                Mybmark.setOnClickListener(new View.OnClickListener(){
                    @Override
                    public void onClick(View view){
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Mybmark.class);
                        startActivity(intent);
                    }
                });
                ...
                Appinfo.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Appinfo.class);
                        startActivity(intent);
                    }
                });
                ...
                Myinfo.setOnClickListener(new View.OnClickListener(){
                    @Override
                    public void onClick(View view){
                        Intent intent = new Intent(getActivity().getApplicationContext(), org.techtown.Single_Fridge.Myinfo.class);
                        intent.putExtra("id", UserId);
                        getActivity().startActivityForResult(intent, 400);
                    }
                });
